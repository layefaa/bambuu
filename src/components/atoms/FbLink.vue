...
<template>
	<a href='#' target='_blank'>
		<svg class='social-icon group' xmlns='http://www.w3.org/2000/svg'  viewBox='0 0 45 45'>
			<path class='fill-[#ADADAD] group-hover:fill-[#95631B]' fill-rule='evenodd' clip-rule='evenodd'
