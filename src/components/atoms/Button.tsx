		...
		case 'button':
			return (
				<button onClick={onClick}
								className={`px-[1.6rem] py-[1rem] font-[400] text-20 relative rounded group overflow-hidden text-bb-primary-white bg-bb-secondary-black inline-flex rounded-[60px] items-center`}>
        <span
